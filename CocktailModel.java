...
public class CocktailModel {
    ...
    public JSONObject getCocktailInformation(String cocktailInformation)  {
        ...
        JSONObject jsonResponse = new JSONObject(); // create a new jsonObject to store all the useful information
        ...
        //Cocktail name returns an array of cocktails.
        //Therefore,we get a random one from the list.
